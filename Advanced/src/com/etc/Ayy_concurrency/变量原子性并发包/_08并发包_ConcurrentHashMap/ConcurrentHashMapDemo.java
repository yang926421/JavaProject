package com.etc.Ayy_concurrency.变量原子性并发包._08并发包_ConcurrentHashMap;
...
/**
 ...
 hashtable是锁定整个数组链表  concurrenthashmap是锁定一个数组上一个位置对应的链表和二叉树  是属于局部锁定
 */
public class ConcurrentHashMapDemo {
    // 定义一个静态的HashMap集合，只有一个容器。
    // public static Map<String,String> map = new HashMap<>();  线程不安全
     public static Map<String,String> map = new Hashtable<>();  //线程安全的,性能较差
